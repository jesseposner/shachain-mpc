...

{
  ...
  ./compile.py -B 256 shachain_step 1 1 0 0 >/dev/null 2>&1
  row "seq K=1, BMR, semi-honest" rep-bmr shachain_step-1-1-0-0
  row "seq K=1, BMR, malicious" mal-rep-bmr shachain_step-1-1-0-0
