...
This is a hub, not a leaf. Every item below is explicitly deferred *into* it,
and none of them can close until it exists:
...
Neither failure mode below fixes the other.
